...
export class ModelResolver {
  constructor() // private hashService: HashService, // private userService: UserService,
  ...
  async initDataTagDemo(): Promise<string> {
    ...
    //     tagType: TagType.SYSTEM,
    //     thumbnail:
    //       "https://cdn.hashnode.com/res/hashnode/image/upload/v1607082785538/EryuLRriM.png?w=200&h=200&fit=crop&crop=entropy&auto=compress",
